...
export class BlockOrderListComponent implements OnInit {
  Orders: any=[];
  constructor(public datepipe: DatePipe,private _SalesOrderService: SalesOrderService, private service: UserService, private router: Router,private _CFAgentService:CFAgentService
...
this.loadedFromDate=false
  ...
  ngOnInit() {
    ...
    {
      this.UserType=UserConstant.SalesPromoter;
  ...
  this.pageNo=pageno;
        ...
        this._SalesOrderService.GetOrderBlockedSalesOrderSearch(this.UserCode,this.UserType,this.FromDate,this.Todate,  this.pageNo, this.OrdersPerPage, this.search).subscribe((data: any) => {
      this.Orders = data ;
  ...
  getAllOrdersCount() {
    ...
    this._SPComponent.setLoading(true);
    this._SalesOrderService.GetOrderBlockedSalesOrderCount(this.UserCode,this.UserType,this.FromDate,this.Todate, this.search).subscribe((res: any) => {
  ...
  download() {
    ...
    this._SPComponent.setLoading(true);
    this._CFAgentService.ExportToExcel(this.FromDate,this.Todate,'pending',this.UserType,this.UserCode, this.search).subscribe(response => {

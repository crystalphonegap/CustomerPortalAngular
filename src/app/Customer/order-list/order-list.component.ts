...
export class CustomerOrderListComponent implements OnInit {
  Orders: any =[];
  constructor(public datepipe: DatePipe, private _OrderServiceService: OrderService, 
    private _CustomerComponent:CustomerComponent,private service: UserService, private router: Router, private _CustomerService: CustomerService
...
this.loadedFromDate=false
  ...
  getPending() {
    ...
    this._OrderServiceService.getOrderCount(this.FromDate, this.Todate, 'Pending', UserCode, this.search).subscribe((res: any) => {
      this.Submitted = res;
  ...
  getDraft() {
    ...
    this._OrderServiceService.getOrderCount(this.FromDate, this.Todate, 'Draft', UserCode, this.search).subscribe((res: any) => {
      this.Draft = res;
      this._CustomerComponent.setLoading(false);
      if (res == "" || res == null) {
        this.Draft = 0;
  ...
  getPosted() {
    ...
    this._OrderServiceService.getOrderCount(this.FromDate, this.Todate, 'Posted', UserCode, this.search).subscribe((res: any) => {
      this.Posted = res;
      this._CustomerComponent.setLoading(false);
      if (res == "" || res == null) {
        this.Posted = 0;
  ...
  getAllOrders(PageNo) {
    ...
    this._OrderServiceService.GetOrderDetails(this.FromDate, this.Todate, this.status, UserCode, this.pageNo, this.OrdersPerPage, this.search).subscribe((data: any) => {
      this.Orders = data ;
      this._CustomerComponent.setLoading(false);
  ...
  getAllOrdersCount() {
    ...
    this._OrderServiceService.getOrderCount(this.FromDate, this.Todate, this.status, UserCode, this.search).subscribe((res: any) => {
  ...
  download() {
    ...
    this._OrderServiceService.downloadFile(this.FromDate, this.Todate, this.status, UserCode, this.search).subscribe(response => {

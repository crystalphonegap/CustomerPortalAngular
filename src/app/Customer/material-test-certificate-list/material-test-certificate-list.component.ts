...
export class MaterialTestCertificateListComponent implements OnInit {
  ...
  LoyalityPoints: any = [];
  constructor(private _MaterialTestCertificateService:MaterialTestCertificateService,public datepipe: DatePipe, private router: Router,
...
Add() {
    this.router.navigateByUrl('/Customer/MaterialTestCertificateUpload');
}


View(ID) {
    localStorage.setItem('ID', ID );
    this.router.navigateByUrl('/Customer/MaterailTestCertificateDetail');
}

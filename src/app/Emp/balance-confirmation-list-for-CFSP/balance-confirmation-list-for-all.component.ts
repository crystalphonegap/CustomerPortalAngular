...
export class BalanceConfirmationListForCFSPComponent implements OnInit {
...
this.loadedFromDate=false
  ...
  getAllBalanceConfirmation(pageno) {
    ...
    this.pageNo=pageno;
    this._BalanceConfirmation.GetSPCFABalanceConfHeaderListForEmployee(this.FromDate,this.Todate,this.status,localStorage.getItem(constStorage.UserType),  this.UserCode, this.pageNo, this.BalanceConfirmationPerPage,this.search).subscribe((data: any) => {
  ...
  getAllBalanceConfirmationCount() {
    this._EmpComponent.setLoading(true);
    this._BalanceConfirmation.GetSPCFABalanceConfHeaderListForEmployeeCount(this.FromDate,this.Todate,this.status,localStorage.getItem(constStorage.UserType),  this.UserCode,this.search).subscribe((res: any) => {
  ...
  pass(BCNo,CustomerCode,BCheader): void {
    ...
    this.router.navigateByUrl('/Emp/BalanceConfirmationViewForCFSP');
  }

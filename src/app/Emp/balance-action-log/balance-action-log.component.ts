...
@Component({
  selector: 'app-balance-action-log',
  templateUrl: './balance-action-log.component.html',
  styleUrls: ['./balance-action-log.component.css']
})
export class BalanceActionLogComponent implements OnInit {
...
this.loadedFromDate=false
  ...
  getAllBalanceConfirmation(pageno) {
   debugger
    ...
    this.pageNo=pageno;
    debugger
    this._BalanceConfirmation.GetBalConfActionReport(this.FromDate,this.Todate,localStorage.getItem(constStorage.UserType),  this.UserCode,this.Region,this.Branch,this.Territory, this.pageNo, this.BalanceConfirmationPerPage).subscribe((data: any) => {
  ...
  getAllBalanceConfirmationCount() {
    this._EmpComponent.setLoading(true);
    this._BalanceConfirmation.GetBalConfActionReportCount(this.FromDate,this.Todate,localStorage.getItem(constStorage.UserType),  this.UserCode,this.Region,this.Branch,this.Territory).subscribe((res: any) => {

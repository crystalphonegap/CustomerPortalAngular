...
@Component({
  selector: 'app-closed-tickets-view',
  templateUrl: './closed-tickets-view.component.html',
  styleUrls: ['./closed-tickets-view.component.css']
})
export class TechnicianClosedTicketsViewComponent implements OnInit {
...
TicketDetail: any = [];
  ...
  Back() {
    this.router.navigateByUrl('/Emp/OpenTicketsDetail');
  }

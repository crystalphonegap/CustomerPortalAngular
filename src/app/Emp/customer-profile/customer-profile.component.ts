...
export class CustomerProfileComponent implements OnInit {
  ...
  constructor(private changeDetection: ChangeDetectorRef,private router: Router,private alertService: AlertService,private _MaterialTestCertificateService: MaterialTestCertificateService,
    private _CustomerService:CustomerService,
     public datepipe: DatePipe, private _TargetSales: TargetSales, private sanitizer: DomSanitizer, private _EmpComponent: EmpComponent,) { }
  PaymnetSales;
  NCR;
  NCRCanvos = "NCRCanvos";
  ...
  BacK(){
    this.router.navigateByUrl('/Emp/CustomerList');
  }
  getRetailer() {

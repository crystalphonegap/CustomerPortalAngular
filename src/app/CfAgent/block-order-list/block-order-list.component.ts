...
export class BlockOrderListComponent implements OnInit {
  Orders: any=[];
  constructor(public datepipe: DatePipe,private _SalesOrderService: SalesOrderService, 
     private router: Router,private _CFAgentService:CFAgentService,private _CfAgentComponent:CfAgentComponent

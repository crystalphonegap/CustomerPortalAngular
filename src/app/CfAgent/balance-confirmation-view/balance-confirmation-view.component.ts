...
import { ModalService } from 'src/app/component/CF_Modal';
...
export class BalanceConfirmationViewComponent implements OnInit {
  bodyText;
  constructor(private _CfAgentComponent:CfAgentComponent,private alertService: AlertService, private modalService: ModalService,
  ...
  Back() {
    ...
    this.router.navigateByUrl('CfAgent/BalanceConfirmation');
  }
  Agree() {

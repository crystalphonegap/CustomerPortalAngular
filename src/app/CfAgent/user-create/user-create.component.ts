...
export class CFUserCreateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.userAdd = new FormGroup({
      ...
      UserTypetxt: new FormControl(UserConstant.CFAgentUser, [Validators.required, Validators.maxLength(256)]),
  ...
  OnSuccess(){
    if(this.i<1){
      this.router.navigateByUrl('/CfAgent/UserList');

...
@Component({
  selector: 'app-mis-report-view-open-ticket-by-user-type',
  templateUrl: './mis-report-view-open-ticket-by-user-type.component.html',
  styleUrls: ['./mis-report-view-open-ticket-by-user-type.component.css']
})
export class MisReportViewOpenTicketByUserTypeComponent implements OnInit {
